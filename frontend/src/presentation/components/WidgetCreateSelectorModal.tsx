...
import type { WidgetCreateSelectorResult,WidgetType } from "@/core/types/ui";

export default function WidgetCreateSelectorModal({
  open,
  onClose,
  onSelect,
}: {
  open: boolean;
  onClose: () => void;
  onSelect: (result: WidgetCreateSelectorResult) => void;
}) {
