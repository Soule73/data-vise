...
export default function WidgetCreatePage() {
  ...
  function getGroupedData(data: any[], config: any) {
    ...
    // Agréger les valeurs par groupBy
  ...
  return (
    <>
      ...
      <div
        className=" bg-white dark:bg-gray-900 rounded shadow dark:border dark:border-gray-700
      ...
      >
        ...
        >
          ...
          <div className="order-1 md:order-1 md:col-span-1 lg:sticky lg:top-0 min-h-[70vh] h-full max-h-[70vh] overflow-y-auto flex flex-col p-1 md:p-4">
            <div className="font-semibold mb-2">Aperçu</div>
          ...
          <div
            className="order-2 md:col-span-1 flex flex-col h-full min-h-0 bg-white dark:bg-gray-800 rounded md:p-4
          "
          >
            <div
              className="flex-1 min-h-0 overflow-y-auto space-y-2 pb-20 config-scrollbar
            md:px-2
            "
            >
              {step === 1 ? (
                ...
                <>
                  <InputField
                    ...
                    id="widget-title"
                  />
                  {Object.entries(WIDGETS[type].configSchema).map(
                    ([field, typeStr]) => {
                          ...
                          <div key={field} className="mb-2">
                            ...
                            <div className="space-y-2">
                              {columns.map((col) => {
                                ...
                                const checked = (config.columns || []).some(
                                  (c: any) => c.key === col
                                );
                                return (
                                  <div
