  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path={ROUTES.dashboard} element={<RequireAuth><BaseLayout><DashboardPage /></BaseLayout></RequireAuth>} />
        ...
        <Route path={ROUTES.roles} element={<RequireAuth><BaseLayout><RoleManagementPage /></BaseLayout></RequireAuth>} />
        <Route path={ROUTES.roles + '/create'} element={<RequireAuth><BaseLayout><RoleCreatePage /></BaseLayout></RequireAuth>} />
        <Route path={ROUTES.users} element={<RequireAuth><BaseLayout><UserManagementPage /></BaseLayout></RequireAuth>} />
